...
namespace WayFinding2 {
    // using std::vector<Geometry::Point> = std::vector<Geometry::Point>;
...
namespace WayFinding {
    ...
    extern std::vector<Geometry::Point> routes_[2][N_][N_];
    ...
    bool GetOfflineRoute(int o, Geometry::Point cnt,
                                     ...
                                     std::vector<Geometry::Point>& output);
    std::vector<Geometry::Point> GetOnlineRoute(int o, int s, int t);
