...
std::vector<Geometry::Point> WayFinding::routes_[2][N_][N_];
...
std::vector<Geometry::Point> WayFinding::GetOnlineRoute(int o, int s, int t) {
    //有没有装东西， 起点， 终点
...
WayFinding2::WayFinding WayFinding2::Way[2];