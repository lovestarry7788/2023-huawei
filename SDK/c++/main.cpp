...
namespace Output {
    ...
    void Forward(int robot_id, double forward) {
        Operation.emplace_back(std::string{"forward " + std::to_string(robot_id) + " " + std::to_string(forward)});
    }

    void Rotate(int robot_id, double rotate) {
        Operation.emplace_back(std::string{"rotate " + std::to_string(robot_id) + " " + std::to_string(rotate)});
    }
